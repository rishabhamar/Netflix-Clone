...
const Head = "text-base text-left text-main font-semibold px-6 py-2 uppercase";
const Text = "text-sm text-left leading-6 whitespace-nowrap px-5 py-3 font-semibold";
          ...
          <td className={`${Text}`}>
            <div className="w-12 p-1 bg-dry border border-border h-12 rounded overflow-hidden">
              <img
                ...
                src={`/images/${data.image ? data.image : "youtube logo.png"}`} // Use template literal for image path
                alt={data?.fullName}
              />
            </div>
          </td>
...
export default Table2; // Export the component
