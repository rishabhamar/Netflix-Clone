            ...
            <div className="container mx-auto px-2">
                <div className="grid grid-cols-2 md:grid-cols-7 xl:grid-cols-12 gap-10 sm:gap-9 lg:gap-11 xl:gap-7 py-10 justify-top">
                    {Links.map((link, index) => (
                        <div key={index} className="col-span-1 md:col-span-2 lg:col-span-3 pb-2.5 sm:pb-0 ">
                    ...
                    <div className="pb-3.5 sm:pb-0 col-span-1 md:col-span-2 lg:col-span-3">
                        <Link to="/">
                            <img src="/youtube logo.png" alt="logo" className="w-2/4 object-contain h-30"  />
                        </Link>
                        <p className="leading-7 text-sm text-border mt-3">
                            ...
                            <br/>
                            <span>
                                Tell: Number nahi hai
                            </span>
                            <br/>
                            <span>
                                Email: kyukarrahahaiye@noemail.com
                            </span>
                        </p>
                    </div>
                </div>
