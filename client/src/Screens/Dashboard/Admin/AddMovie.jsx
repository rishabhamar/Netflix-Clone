    ...
    <SideBar>
        ...
        <div className='flex flex-col gap-6'>
            ...
            <div className='w-full grid md:grid-cols-2 gap-6'>
                ...
                <div className='flex flex-col gap-2'>
                    ...
                    <div className='w-32 h-32 p-2 bg-main border border-border rounded'>
                        <img src="/images/movies/aotd.jpg"  alt=" " className='w-full h-full object-cover rounded' />
                    </div>
                </div>
                {/* image with title */}
                <div className='flex flex-col gap-2'>
                    ...
                    <Uploader />
                    <div className='w-32 h-32 p-2 bg-main border border-border rounded'>
                        <img src="/images/movies/godfather.jpg"  alt=" " className='w-full h-full object-cover rounded' />
                    </div>
                </div>
            </div>
            ...
            <div className='w-full grid lg:grid-cols-2 gap-6 items-start'>
                ...
                <div className='grid 2xl:grid-cols-4 lg:grid-cols-4 sm:grid-cols-4 grid-cols-2 gap-4'>
                    {
